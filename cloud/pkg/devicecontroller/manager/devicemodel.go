...
func NewDeviceModelManager(client *kubernetes.Clientset, namespace string) (*DeviceModelManager, error) {
	lw := cache.NewListWatchFromClient(client, "devicemodels", namespace, fields.Everything())
